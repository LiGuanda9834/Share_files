  ...
  //void dealWithAbc(int solveType,int startUp,bool interrupt=false);
     ...
     */
     ...
     /** For strong branching.  On input lower and upper are new bounds
         ...
         status and number of iterations
     */
     int strongBranching2(int numberVariables, const int * variables,
                         double * newLower, double * newUpper,
                         double ** outputSolution,
                         int * outputStatus, int * outputIterations,
                         bool stopOnFirstInfeasible = true,
                         bool alwaysFinish = false,
                         int startFinishOptions = 0);
	 void startStrongBranching();
	 void endStrongBranching( int option );
	 void saveLpInfo();
	 void recoverLpInfo( int option );
//	 double chebweikun;
//	 ClpFactorization *sFactorization1;
//	 int sNumberFake1;
//	 double *sSolution1;
//	 unsigned char *sStatus1;
//	 double *sLower1;
//	 double *sUpper1;
//	 double *sObjective1;
//	 int *sPivot1;
